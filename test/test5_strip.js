...
for(const n of ['11','12','13','14','21','22','23','24','27','61','82','81','181','281'])
  ok(!nos.includes(n), 'レコード'+n+'を保存しない');
for(const n of ['1','4','5','51','52','62','63','64','101','111','201','211','221','231','241'])
...
ok(!saved.drugs[0].補足.length, '薬品補足（自由記述）は保存されない（監査修正6）');
ok(!s.includes('一包化')&&!s.includes('後発品変更不可'), '自由記述の文字列が保存に残らない');
